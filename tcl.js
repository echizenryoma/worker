    ...
    <body>
      <div class="container">
        <form id="uploadForm" enctype="multipart/form-data">
          ...
          <input type="file" id="file" name="file" accept=".jpg,.png,.jpeg,.heic,.mp4,.mov" required>
          <p id="fileSizeInfo" style="font-size: 14px; color: #888; margin-top: 5px;">(最大可上传 10 MB 的文件)</p>
        </form>
        <div id="result"></div>
